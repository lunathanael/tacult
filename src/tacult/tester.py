...
def main(args=_args):
    ...
    pit.load_checkpoints_to_pit(checkpoint_dir="./temp/resnet", num_sims_list=[2], old=True)
    pit.load_checkpoints_to_pit(checkpoint_dir="./temp/resnet3", num_sims_list=[2])
    pit.load_checkpoints_to_pit(checkpoint_dir="./temp/run3", num_sims_list=[2], old=True)
